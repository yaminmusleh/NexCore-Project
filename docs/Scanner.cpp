...
void Scanner::Init() {
	...
	noSym = 28;
	int i;
	for (i = 65; i <= 90; ++i) start.set(i, 17);
	for (i = 97; i <= 122; ++i) start.set(i, 17);
	for (i = 48; i <= 57; ++i) start.set(i, 18);
	start.set(61, 19);
	start.set(33, 20);
	start.set(60, 21);
	start.set(62, 22);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 17:
			...
			if ((ch >= L'0' && ch <= L'9') || (ch >= L'A' && ch <= L'Z') || (ch >= L'a' && ch <= L'z')) {AddCh(); goto case_17;}
