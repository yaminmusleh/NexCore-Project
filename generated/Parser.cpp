...
bool Parser::StartOf(int s) {
	...
	static bool set[4][32] = {
		...
		{x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,T,x,x, T,T,T,x, T,T,x,x},
		{x,x,x,x, T,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x},
		{x,x,x,x, x,x,x,x, x,T,x,x, x,x,x,x, x,x,x,x, x,T,T,T, x,x,x,x, x,x,x,x}
	};
...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 26: s = coco_string_create(L"\"iff\" expected"); break;
			case 27: s = coco_string_create(L"\"otherwise\" expected"); break;
			case 28: s = coco_string_create(L"\"for\" expected"); break;
			case 29: s = coco_string_create(L"\"whilst\" expected"); break;
			case 30: s = coco_string_create(L"??? expected"); break;
			case 31: s = coco_string_create(L"invalid Statement"); break;
			case 32: s = coco_string_create(L"invalid IfStmt"); break;
			case 33: s = coco_string_create(L"invalid ForInit"); break;
			case 34: s = coco_string_create(L"invalid UnaryExpr"); break;
			case 35: s = coco_string_create(L"invalid PrimaryExpr"); break;
